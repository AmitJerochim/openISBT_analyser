...
class AuthenticateMatchingUnit : MatchingUnit{

    val log = LoggerFactory.getLogger("AuthenticateMatchingUnit");

    override fun getSupportedOperation(): String {
        return AbstractPatternOperation.AUTHENTICATE.name;
    }
                        ...
                        if (content.schema != null) {
                            ...
                            if (schema.type == "object") {
                            		if (schema.properties != null){
																		...
																		if(
																				props.toLowerCase().contains("token")
																		){  
																				isAuth = true;
																		}
																}
